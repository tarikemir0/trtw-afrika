...
const LatestFeatured: React.FC = () => {
    ...
    const handleTabClick = (tabName: string, event: MouseEvent<HTMLAnchorElement>): void => {
        ...
        changeTab(tabName); // Sekmeyi değiştir
    };

    return (
        <div className="bg-white text-sm font-medium text-left text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                ...
                <ul className="flex flex-wrap -mb-px">
                    <li className="me-2">
                        <a
                            ...
                            className={`inline-block p-4 border-b rounded-t-lg ${
                                activeTab === 'FEATURED' ? 'text-red-600 border-red-600' : 'text-gray-500 hover:text-gray-600 hover:border-red-600 dark:hover:text-gray-300'
                            }`}
                        >
                            FEATURED
                        </a>
                    ...
                    <li className="me-2">
                        <a
                            ...
                            className={`inline-block p-4 border-b rounded-t-lg ${
                                activeTab === 'LATEST NEWS' ? 'text-red-600 border-red-600' : 'text-gray-500 hover:text-gray-600 hover:border-red-600 dark:hover:text-gray-300'
                            }`}
                        >
                            LATEST NEWS
                        </a>
                ...
                {activeTab === 'FEATURED' && (
                    <div className={"text-black"}>
                        ...
                        <div className={"flex gap-4 items-center"}><img
                            ...
                            alt="FEATURED"/>
                            <p className={"font-bold"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                Obcaecati, optio?</p></div>
                        <div className={"flex gap-4 items-center"}><img
                            className="w-48 h-48 object-cover m-2 "
                            src="https://fastly.picsum.photos/id/85/200/200.jpg?hmac=gQRdT-HPw1azaNf38WLW_QZv7aC0WjwOSM4Sf5kWm3U"
                            alt="FEATURED"/>
                            <p className={"font-bold"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi, ullam!</p></div>
