const headline = () => {
  return (
    ...
    <div className="relative">
      <img className="w-full object-cover" src="https://cdn-i.pr.trt.com.tr/trtafricaswa/w960/h540/q70/18320903_0-182-5392-3037.jpeg" />
      <div className="absolute w-full bottom-0 left-0 text-left md:px-4 md:pb-10 md:bg-gradient-to-t md:from-black p-2 bg-slate-900 md:bg-transparent">
        ...
        <h3 className="text-white font-bold md:text-4xl text-xs sm:text-3xl ">Jeshi la Sudan lakataa usitishaji vita hadi RSF iondoke kwenye maeneo ya raia</h3>
      </div>
    </div>
  )
}
