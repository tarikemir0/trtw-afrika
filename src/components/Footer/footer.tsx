        ...
        <footer className="bg-footer text-white py-8">
            <div className="container mx-auto flex flex-col md:flex-row md:justify-between ">
                <div className="flex-1 flex flex-col items-center md:items-stretch">
                    <img src="http://www.trtafrika.com/images/logo.svg" className="mb-4 w-1/2 md:w-3/4" />
                    <h4 className="text-sm font-thin mb-4 text-footerp md:text-left">Hakimiliki © TRT Afrika 2024</h4>
                </div>
                <div className="flex-1 lg:flex lg:justify-around md:flex md:justify-around ">
                    <ul className="list-none">
                        ...
                        <li>
                            <a href="#" className="text-sm font-thin text-footerp mb-4 hover:text-footerp">
                                Kuhusu TRT Afrika
                            </a>
                        </li>
                        <li>
